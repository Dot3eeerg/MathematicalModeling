...
def plot_mesh_with_elements(points, elements = None, dirichlet = None, neumann = None):
    ...
    if dirichlet is not None:
        ...
        ax.scatter(dx, dy, color='green', marker='o', label="Узлы с первым краевым условием")
...
# elements = read_elements_from_file("elements")  # Replace "elements.txt" with your elements file path
...
plot_mesh_with_elements(mesh_points)
